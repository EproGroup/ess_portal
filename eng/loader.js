...
(function() {
  ...
  if (!raw) {
    document.write('<script type="text/javascript" src="../js/lib/ol3191.js"></script>');
	document.write('<script type="text/javascript" src="../js/lib/notify/notify.js"></script>');
	document.write('<script type="text/javascript" src="../js/lib/hslayers/hs.source.SparqlJson.js"></script>');
	document.write('<script type="text/javascript" src="../js/lib/sweetalert/sweetalert2.min.js"></script>');
  } else {
    window.CLOSURE_NO_DEPS = true; // we've got our own deps file
    document.write('<scr' + 'ipt type="text/javascript" src="../closure-library/closure/goog/base.js"></scr' + 'ipt>');
    document.write('<scr' + 'ipt type="text/javascript" src="../build/ol-deps.js"></scr' + 'ipt>');
    document.write('<scr' + 'ipt type="text/javascript" src="../js/' + scriptId + '-require.js"></scr' + 'ipt>');
  }
